...
<div class="container">
	...
	<a class="btn btn-warning" href="/Financy/controller?acao=Listar&tipo=investimento">Voltar</a>
	</div>
	<h2 class="username">Novo Investimento</h2>
	...
	<form action="controller" method="post">
		...
		<div class="form-group">
			...
			<input type="text" name="nomeInvestimento" id="id-nome" class="form-control">
		</div>
		<div class="form-group">
			<label for="id-valor">Valor</label>
			<input type="text" name="valorInvestimento" id="id-valor" class="form-control">
		</div>
		<div class="form-group">
			<label for="id-realização">Realização</label>
			<input type="date" name="dataRealizacao" id="id-realização" class="form-control">
		</div>
		<div class="form-group">			
			<label for="id-vencimento">Vencimento</label>
			<input type="date" name="dataConclusao" id="id-vencimento" class="form-control">
		</div>
		<div class="form-group">			
