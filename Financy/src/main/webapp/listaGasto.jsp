  ...
  <body class="d-flex flex-row justify-content-center">
    <div class="sidebar d-none d-lg-flex flex-column align-items-center">
      ...
      <div class="links d-flex flex-column justify-content-around">
        ...
        <a class="current-page" href="controller?acao=Listar&tipo=gasto">Gastos</a>
    ...
    <div class="main-box d-flex flex-column justify-content-around">
      ...
      <h2 class="username">Gastos</h2>
         <div class="col-12 d-flex flex-row justify-content-end">
        	<a class="btn btn-light" href="/Financy/controller?acao=AbrirFormCadastro&tipo=gasto">Adicionar</a>
        </div>
        <div class="user-box d-flex flex-column align-items-center">
            <table>
                <tr>
                	...
                	<tr>
                		<td>R$ <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${g.valor}" /></td>
                		<td>
                			<fmt:formatDate value="${g.data}" pattern="dd/MM/yyy"/>
                		</td>
                		<td>${g.descricao}</td>
                		...
                		<td>
                			<c:url value="controller" var="link">
                				...
                				<c:param name="tipo" value="gasto"></c:param>
                				<c:param name="codigoGasto" value="${g.cdGasto}"></c:param>
                			</c:url>
                			
                			<a class="btn btn-warning" href="${link}">Editar</a>
                		</td>
                		<td>
                			<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#excluirModal" onclick="codigoExcluir.value = ${g.cdGasto}">
  								Excluir
							</button>
						</td>
                	 </tr>
