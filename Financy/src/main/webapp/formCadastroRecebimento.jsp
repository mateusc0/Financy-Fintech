...
<div class="container">
	...
	<a class="btn btn-warning" href="/Financy/controller?acao=Listar&tipo=recebimento">Voltar</a>
	</div>
	<h2 class="username">Novo Recebimento</h2>
	...
	<form action="controller" method="post">
		...
		<div class="form-group">
			...
			<input type="text" name="valorRecebimento" id="id-valor" class="form-control">
		</div>
		<div class="form-group">
			<label for="id-data">Data</label>
			<input type="date" name="dataRecebimento" id="id-data" class="form-control">
		</div>
		<div class="form-group">
			<label for="id-descricao">Descrição</label>
			<input type="text" name="descricaoRecebimento" id="id-descricao" class="form-control">
		</div>
