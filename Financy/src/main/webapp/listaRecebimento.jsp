  ...
  <body class="d-flex flex-row justify-content-center">
    <div class="sidebar d-none d-lg-flex flex-column align-items-center">
      ...
      <div class="links d-flex flex-column justify-content-around">
        ...
        <a class="current-page" href="controller?acao=Listar&tipo=recebimento">Recebimentos</a>
    ...
    <div class="main-box d-flex flex-column justify-content-around">
      ...
      <h2 class="username">Recebimentos</h2>
       <div class="col-12 d-flex flex-row justify-content-end">
        	<a class="btn btn-light" href="/Financy/controller?acao=AbrirFormCadastro&tipo=recebimento">Adicionar</a>
        </div>
        <div class="user-box d-flex flex-column align-items-center">
            <table>
                ...
                <c:forEach items="${recebimentos}" var="r">
                	<tr>
                		<td>R$ <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${r.valor}" /></td>
                		<td>
                			<fmt:formatDate value="${r.data}" pattern="dd/MM/yyy"/>
                		</td>
                		<td>${r.descricao}</td>
                		<td>
                			<c:url value="controller" var="link">
                				<c:param name="acao" value="AbrirFormAtualizar"></c:param>
                				<c:param name="tipo" value="recebimento"></c:param>
                				<c:param name="codigoRecebimento" value="${r.cdRecebimento}"></c:param>
                			</c:url>
                			
                			<a class="btn btn-warning" href="${link}">Editar</a>
                		</td>
                		<td>
                			<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#excluirModal" onclick="codigoExcluir.value = ${r.cdRecebimento}">
  								Excluir
							</button>
                		</td>
                	 </tr>
